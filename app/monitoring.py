...
class MetricsCollector:
    ...
    def record_prediction(
        self, predicted_class: str, confidence: float, processing_time: float
    ):
    ...
    def get_metrics(self) -> Dict:
        ...
        with self.lock:
            ...
            metrics = {
                ...
                "predictions_per_minute": (self.total_predictions / uptime) * 60
                if uptime > 0
                else 0,
                ...
                "average_processing_time_ms": sum(self.processing_times)
...
def log_prediction(
    ...
    try:
        ...
        log_file = os.path.join(
            log_dir, f"predictions_{datetime.now().strftime('%Y%m%d')}.jsonl"
        )
...
class ModelMonitor:
    ...
    def set_baseline(self, distribution: Dict[str, int]):
        ...
        self.baseline_distribution = {k: v / total for k, v in distribution.items()}
    ...
    def check_drift(self) -> Dict:
        ...
        current_dist = {k: v / total for k, v in self.current_distribution.items()}
